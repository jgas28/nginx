...
<div class="max-w-6xl mx-auto bg-white p-6 rounded shadow">
    ...
    <div class="flex items-center justify-between mb-6">
        <form action="{{ route('liquidations.reviewList') }}" method="GET" class="flex space-x-4 w-full">
            <!-- CVR Number Filter -->
            <div class="flex-1">
        ...
        <table class="min-w-full border border-gray-300">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="p-3 border">CVR Type</th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="p-3 text-center text-gray-500">No liquidations found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
