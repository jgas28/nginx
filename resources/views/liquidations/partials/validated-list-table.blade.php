        ...
        <div class="space-y-3 p-4 md:hidden">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                <p class="text-xs font-semibold uppercase tracking-[0.16em] text-slate-400">Collector</p>
                                <p class="mt-1 text-sm text-slate-700">{{ trim(($liquidation->collector->fname ?? '') . ' ' . ($liquidation->collector->lname ?? '')) ?: 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <a href="{{ route('liquidations.validated', $liquidation->id) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-2xl border px-4 py-2.5 text-sm font-semibold shadow-md transition sm:w-auto" style="background-color:#059669;border-color:#047857;color:#ffffff;">
            ...
            @empty
                <div class="rounded-2xl border border-dashed border-slate-200 px-4 py-10 text-center text-sm text-slate-500">
                    No validated liquidations found.
                </div>
            @endforelse
        </div>
