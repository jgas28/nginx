                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 align-top">
                                <div class="flex justify-end">
                                    <a href="{{ route('liquidations.review', $liquidation->id) }}" class="inline-flex min-w-[128px] items-center justify-center gap-2 rounded-2xl border border-cyan-700 bg-cyan-600 px-4 py-2.5 text-xs font-semibold text-white shadow-md shadow-cyan-600/20 transition hover:bg-cyan-700 hover:border-cyan-800" style="background-color:#0891b2;color:#ffffff;border-color:#0e7490;">
