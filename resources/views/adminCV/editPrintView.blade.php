...
<div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow">
    <h4 class="text-xl font-semibold mb-6">Edit Payment Details</h4>

    <form action="{{ route('adminCV.updateReference', $vouchers->id) }}" method="POST" class="space-y-5">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            ...
            <div class="md:col-span-2">
                <input
                    type="text"
                    value="{{ ucfirst(str_replace('_', ' ', $vouchers->payment_type)) }}"
                    readonly
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            ...
            <div class="md:col-span-2">
                <input
                    ...
                    value="{{ old('reference_number', $vouchers->reference_number) }}"
                    required
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            ...
            <div class="md:col-span-2">
                <input
                    type="text"
                    value="{{ number_format($vouchers->amount, 2) }}"
                    readonly
                    class="w-full rounded-md border-gray-300 bg-gray-100 text-gray-700 shadow-sm focus:outline-none"
                >
            </div>
