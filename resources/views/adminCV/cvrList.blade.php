...
@section('content')
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <form method="GET" action="{{ route('adminCV.cvrList') }}" class="flex items-center flex-grow space-x-4">
    ...
    <div id="cashVoucherRequests-table" class="bg-white shadow-md rounded-lg overflow-hidden">
        @include('adminCV.cvrList_table', ['cashVoucherRequests' => $cashVoucherRequests])
    </div>
@endsection
...
@section('scripts')
    ...
    <script>
        ...
        function fetchCashVoucherRequests(searchQuery) {
            ...
            fetch(`{{ route('adminCV.cvrList') }}?search=${searchQuery}`)
