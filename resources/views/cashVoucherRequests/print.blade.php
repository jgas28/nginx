                         ...
                         <td style="border: 1px solid #ccc; padding: 0;">
                            <table style="width: 100%; border-collapse: collapse; font-size: 10px;">
                                <tr>
                                    ...
                                    <td style="text-align: right; padding: 4px;">₱ {{ number_format($cashVoucherRequest->amount, 4) }}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; padding: 4px;">Net Amount</td>
                                    <td style="text-align: right; padding: 4px;">₱ {{ number_format($baseAmount, 4) }}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; padding: 4px;">VAT (12%)</td>
                                    <td style="text-align: right; padding: 4px;">₱ {{ number_format($vatAmount, 4) }}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; padding: 4px;">{{ $cashVoucherRequest->withholdingTax->description }}</td>
                                    <td style="text-align: right; padding: 4px;">₱ {{ number_format($taxDeduction, 4) }}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; font-weight: bold; padding: 4px; color: red;">Total</td>
                                    <td style="text-align: right; font-weight: bold; color: red; padding: 4px;">₱ {{ number_format($finalAmount, 4) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 0;">
                            <table style="width: 100%; border-collapse: collapse; font-size: 10px;">
                                <tr>
                                    <td style="text-align: left; padding: 4px;">Subtotal</td>
                                    <td style="text-align: right; padding: 4px;">₱ {{ number_format($cvrApprovals->amount, 4) }}</td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; padding: 4px;">Net Amount</td>
                                    <td style="text-align: right; padding: 4px;">₱ {{ number_format($cvrApprovals->amount, 4) }}</td>
                                ...
                                <tr>
                                    <td style="text-align: left; font-weight: bold; padding: 4px; color: red;">Total</td>
                                    <td style="text-align: right; font-weight: bold; color: red; padding: 4px;">₱ {{ number_format($cvrApprovals->amount, 4) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
