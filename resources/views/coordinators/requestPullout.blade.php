...
<div class="bg-white shadow-lg rounded-lg mt-6">
    ...
    <div class="p-6">
        <form action="{{ route('coordinators.storePullout') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <fieldset class="bg-gray-100 p-4 rounded">
                ...
                <div class="flex flex-col md:flex-row md:items-end md:space-x-4 space-y-4 md:space-y-0">
                    ...
                    <div id="tax_base_container" class="w-full md:w-1/3 hidden">
                        <input type="number" name="tax_base_amount" class="input w-full" placeholder="Enter base amount" step="0.01" min="0">
