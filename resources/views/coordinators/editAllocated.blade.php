...
@section('content')
    ...
    <form action="{{ route('coordinators.updateAllocated', $deliveryRequest) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="max-w mx-auto p-6 bg-white rounded-lg shadow-md space-y-6 mb-6">
            <div class="border border-gray-300 rounded-md p-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div class="md:col-span-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Remarks</label>
                        <div id="remarks-container" class="space-y-2">
                            @if(!empty($allocate->remarks) && is_array($allocate->remarks))
                                @foreach($allocate->remarks as $remark)
                                    <div class="text-gray-800 bg-gray-100 px-4 py-2 rounded-lg shadow-sm w-full">
                                        {{ $remark }}
                                    </div>
                                @endforeach
                            @else
                                <div class="text-gray-500 italic">No remarks available.</div>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w mx-auto p-6 bg-white rounded-lg shadow-md space-y-6">
           <div class="border border-gray-300 rounded-md p-4">
                @if(isset($allocate))
        ...
        <div class="border bg-white p-4 space-y-6 mt-6">
            ...
            <div class="flex flex-wrap -mx-2">
                ...
                <input type="number" name="delivery_rate" id="delivery_rate" step="0.01" min="0"
                ...
                <select name="expense_type_id" id="expense_type_id" readyonly
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                        bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0 cursor-not-allowed">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-4/12 px-2 mb-4">
                            ...
                            <input type="text" name="regular[{{ $index }}][site_name]" id="regular_site_name_{{ $index }}" 
                                value="{{ old('regular.' . $index . '.site_name', $lineItem->site_name) }}" readonly
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                        bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0 cursor-not-allowed">
                        ...
                        <div class="w-full md:w-4/12 px-2 mb-4">
                            ...
                            <textarea name="regular[{{ $index }}][delivery_address]" id="regular_delivery_address_{{ $index }}" readonly
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                        bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0 cursor-not-allowed" rows="3">{{ old('regular.' . $index . '.delivery_address', trim($lineItem->delivery_address ?? '')) }}</textarea>
        ...
        @if($deliveryLineItems->isNotEmpty())
            <div id="multi-drop-fields" >
                <div id="multi-drop-items">
                        ...
                        <div class="border border-gray-300 bg-white p-4 mt-3 rounded">
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-full md:w-1/3 px-2 mb-4">
                                    ...
                                    <select name="multi_drop[0][warehouse_id]" id="multi_drop_0_warehouse_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                        bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0 cursor-not-allowed" readonly>
                                        @foreach($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}"
                                ...
                                <div class="w-full md:w-1/3 px-2 mb-4">
                                    ...
                                    <select name="multi_drop[0][add_on_rate]" id="multi_drop_0_add_on_rate" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                        bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0 cursor-not-allowed" readonly>
                                            ...
                                            <div class="flex flex-wrap -mx-2">
                                                ...
                                                <div class="w-full md:w-1/6 px-2 mb-4">
                                                    ...
                                                    <input type="text" name="multi_drop[{{ $index }}][site_name]" id="site_name_{{ $index }}" 
                                                        ...
                                                        value="{{ old("multi_drop.{$index}.site_name", $lineItem->site_name) }}"readonly>
                        ...
                        focus:outline-none focus:ring-0"
                                                ...
                                                <div class="w-full md:w-1/4 px-2 mb-4">
                                                    ...
                                                    <textarea name="multi_drop[{{ $index }}][delivery_address]" id="delivery_address_{{ $index }}" 
                                                        class="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0" readonly>{{ old("multi_drop.{$index}.delivery_address", $lineItem->delivery_address) }}</textarea>
                    ...
                    <div id="Allocation-fields" class="">
                                ...
                                <div class="flex flex-wrap -mx-2">
                                    <div class="w-full md:w-1/3 px-2 mb-4">
                                        ...
                                        <input type="text" name="multi_pickup[0][site_name]" id="multi_pickup_0_site_name" 
                                            class="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0" 
                                            value="{{ old('multi_pickup.0.site_name', $deliveryLineItems->first()->site_name) }}" readonly>
                                    ...
                                    <div class="w-full md:w-1/3 px-2 mb-4">
                                        ...
                                        <textarea name="multi_pickup[0][delivery_address]" id="multi_pickup_0_delivery_address" 
                                            class="w-full border border-gray-300 rounded px-3 py-2 bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none focus:ring-0" 
                                            style="height: 120px;" readonly>{{ old('multi_pickup.0.delivery_address', $deliveryLineItems->first()->delivery_address) }}</textarea>
