...
<table class="table-auto w-full text-sm text-left text-gray-600">
    <thead class="bg-gray-100 text-gray-700">
        <tr>
            ...
            <th class="py-2 px-4 border-b">Region Name</th>
    ...
    <tbody>
        @foreach($regions as $region)
            <tr class="hover:bg-gray-50">
                ...
                <td class="py-2 px-4 border-b">{{ $region->area->area_code ?? 'N/A' }}</td>
                <td class="py-2 px-4 border-b">
                    <a href="{{ route('regions.edit', $region) }}" class="btn btn-warning bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600">
                        Edit
                    </a>
