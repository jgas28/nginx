...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    {{-- Filter form: No approver select, fixed to approver 3 --}}
    <form method="GET" action="{{ route('running_balance.davaoFunds') }}" class="mb-6">
        <div class="grid grid-cols-1 sm:grid-cols-5 gap-4">
            ...
            {{-- Optional: Can keep for clarity, but not required since controller enforces it --}}
    ...
    {{-- Summary Card for Davao --}}
    <div class="mb-6">
        <h3 class="text-xl font-semibold mb-2">Running Balance - Davao</h3>
