    ...
    <div class="grid gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-[26px] border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-[13px] font-semibold uppercase tracking-[0.16em] text-emerald-700">Running Balance</div>
                    <div class="mt-1 text-3xl font-black {{ $runningTotal < 0 ? 'text-rose-600' : 'text-slate-900' }}">
        ...
        <div class="rounded-[26px] border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                <span class="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-500 text-white">
                    <i class="fas fa-triangle-exclamation text-lg"></i>
                </span>
                <div>
                    <div class="text-[13px] font-semibold uppercase tracking-[0.16em] text-amber-700">Uncollected</div>
                    <div class="mt-1 text-3xl font-black text-slate-900">PHP {{ number_format($uncollectedTotal, 2) }}</div>
                </div>
            </div>
        </div>
