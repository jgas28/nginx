    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        ...
        <div class="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden flex flex-col">
            <div class="bg-gradient-to-r from-purple-500 to-purple-700 text-white px-6 py-4">
                <h2 class="text-xl font-semibold">CVR Approvals</h2>
            </div>
            <div class="px-6 py-4 flex-grow">
        ...
        {{-- Liquidations --}}
        <div class="bg-white shadow-lg rounded-xl border border-gray-200 overflow-hidden flex flex-col">
            <div class="bg-gradient-to-r from-teal-500 to-teal-700 text-white px-6 py-4">
                <h2 class="text-xl font-semibold">Liquidations</h2>
            </div>
            <div class="px-6 py-4 flex-grow">
