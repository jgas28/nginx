    ...
    <div class="rounded-[28px] border border-slate-200 bg-white px-5 py-6 shadow-sm sm:px-8">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <h1 class="mt-4 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Admin Cash Voucher Request</h1>
                <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                    Review internal and RPM cash vouchers with a faster table, clearer actions, and a cleaner request queue.
                </p>
            </div>
            <a href="{{ route('admin.create') }}"
               class="inline-flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 sm:w-auto">
