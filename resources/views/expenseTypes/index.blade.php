...
@section('content')
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <form method="GET" action="{{ route('expenseTypes.index') }}" class="flex items-center flex-grow space-x-4">
        ...
        <a href="{{ route('expenseTypes.create') }}" class="btn btn-primary bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 ml-4 whitespace-nowrap">
...
document.getElementById('btnCreate').addEventListener('click', function () {
    ...
    function fetchRegions(searchQuery) {
        ...
        fetch(`{{ route('expenseTypes.index') }}?search=${searchQuery}`)
